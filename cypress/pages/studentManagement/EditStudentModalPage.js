class EditStudentModalPage {
  get modalTitle() {
    return cy.contains("h2, .modal-title", "Edit Student");
  }
  get firstNameInput() {
  ...
  get dateOfBirthInput() {
    return cy.get('input[name="dateOfBirth"], input[placeholder*="date"]');
  }
...
module.exports = EditStudentModalPage;